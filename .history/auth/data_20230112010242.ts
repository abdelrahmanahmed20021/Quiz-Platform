export const data = [
    ...
    {
        "quest": "Which type of memory is used by an Array in C++ programming language?",
        "img":"",
        "a": "Contiguous",
        "b": "None-contiguous",
        "c": "Both A and B",
    ...
    {
        "quest": "How many types of the array are there in the C++ programming language?",
        "img":"",
    ...
    {
        "quest": "What did we call an array of the one-dimensional array?",
        "img":"",
    ...
    {
        "quest": "How many types of elements can an array store?",
        "img":"",
    ...
    {
        "quest": "Which one of the following given statements is correct about the increment operator?",
        "img":"",
    ...
    {
        "quest": "Which one of the following statements about the pre-increment is true?",
        "img":"",
    ...
    {
        "quest": "Which of the following concept is used by pre-increment?",
        "img":"",
        "a": "call by value",
        "b": "call by reference",
        "c": "queue",
    ...
    {
        "quest": "In C++, which of the following has the associatively of left to right?",
        "img":"",
        "a": "Addressof",
        "b": "Unary operator",
        "c": "Logical not",
    ...
    {
        "quest": " In C++, can a for loop statement contain another for loop statement?",
        "img":"",
        "a": "No",
        "b": "Yes",
        "c": "Runtime error",
    ...
    {
        "quest": "Which of the following operators has the highest precedence?",
        "img":"",
        "a": "%",
        "b": "/",
        "c": "*",
