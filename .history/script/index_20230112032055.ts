...
window.addEventListener("load",()=>{
    if(sec_screen.requestFullscreen) {
      ...
      }else if (sec_screen.mozRequestFullScreen) {
        sec_screen.mozRequestFullScreen();     // Firefox
      }else if (sec_screen.webkitRequestFullscreen) {
        sec_screen.webkitRequestFullscreen();  // Safari
      }else if(sec_screen.msRequestFullscreen) {
        sec_screen.msRequestFullscreen();      // IE/Edge
      }
})