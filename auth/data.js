export const data = [
    ...
    {
        "quest": "Q10.What will be the output of the following C++ program?",
    ...
    {
        "quest": "Q11.Which of the following is the address operator?",
        "img": "",
        "a": "@",
        "b": "#",
        "c": "&",
    ...
    {
        "quest": "Q12.Which of the following statements is correct about the formal parameters in C++?",
        "img": "",
    ...
    {
        "quest": "Q13.C++ is a ___ type of language.",
        "img": "",
    ...
    {
        "quest": "Q13.Which of the following refers to characteristics of an array?",
        "img": "",
    ...
    {
        "quest": "Q14.If we stored five elements or data items in an array, what will be the index address or the index number of the array's last data item?",
        "img": "",
        "a": "3",
        "b": "5",
        "c": "4",
    ...
    {
        "quest": "Q15.Which type of memory is used by an Array in C++ programming language?",
        "img": "",
        "a": "Contiguous",
        "b": "None-contiguous",
        "c": "Both A and B",
    ...
    {
        "quest": "Q16.How many types of the array are there in the C++ programming language?",
        "img": "",
    ...
    {
        "quest": "Q17.What did we call an array of the one-dimensional array?",
        "img": "",
    ...
    {
        "quest": "Q18.How many types of elements can an array store?",
        "img": "",
    ...
    {
        "quest": "Q19.Which one of the following given statements is correct about the increment operator?",
        "img": "",
        ...
        "answer": "d",
        "explanation": "The Increment operator (or ++) is one of the basic operators in C++. Usually, it is used in several types of loop statements for the counter. Whenever the increment operator (or ++) gets executed, it adds or made an increment of 1 to its operand. To understand it more clearly, you can consider the example given below:"
    },
    {
        "quest": "Q20.Which one of the following statements about the pre-increment is true?",
        "img": "",
        "a": "Pre Incrementisusually faster than the post-increment",
        ...
        "answer": "a",
        "explanation": " Pre Increment is usually faster than the post-increment because it takes one-byte instruction whereas the post-increment takes two-byte instruction."
    },
    {
        "quest": "Q21.Which of the following concept is used by pre-increment?",
        "img": "",
        "a": "call by value",
        "b": "call by reference",
        "c": "queue",
        "d": "call by name",
        "answer": "b",
        "explanation": "The pre-increment usually uses the concept of ' call by reference ' as the changes are reflected back to the memory cells/variables."
    },
    {
        "quest": "Q22.In C++, which of the following has the associatively of left to right?",
        "img": "",
        "a": "Addressof",
        "b": "Unary operator",
        "c": "Logical not",
        ...
        "answer": "d",
        "explanation": "In C++, the array elements have the associatively of left to right. So the correct answer will be option D."
    },
    {
        "quest": "Q23.In C++, can a for loop statement contain another for loop statement?",
        "img": "",
        "a": "No",
        "b": "Yes",
        "c": "Runtime error",
        "d": "None of the above",
        "answer": "b",
        "explanation": "In the c++ programming language, afor loop statement can contain another for loop in itself known as the nested for loop."
    },
    {
        "quest": "Q24.Which of the following operators has the highest precedence?",
        "img": "",
        "a": "%",
        "b": "/",
        "c": "*",
        ...
        "answer": "d",
        "explanation": "All the mentioned operators in the above-given questions have the same precedence. So the correct answer is D."
    },
    /*
    {
        "quest": "",
